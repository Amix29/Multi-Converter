...
- macOS `.app` bundles may contain relative internal symbolic links, especially inside frameworks. Packaging must preserve those links but still reject absolute links, broken links and links that escape the engine source tree.
