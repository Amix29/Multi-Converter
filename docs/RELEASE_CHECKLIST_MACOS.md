...
- The workflow also runs `npm run status:v1.0.5 -- --require-ready`; it must fail until the clean-Mac smoke-test receipt, final security approval and final README macOS availability row are recorded.
