...
- The tracked-file secret scan now includes GitHub workflow files, private test repository references, maintainer-local Windows paths, Apple signing key/certificate/profile filenames and accidental Apple/Tauri signing secret values.
