...
assert.match(linuxEngineStagingWorkflow, /pdfium_archive_url:/, "Linux engine staging workflow must require a PDFium input archive");
...
assert.match(linuxEngineStagingWorkflow, /pandoc_archive_url:/, "Linux engine staging workflow must require a Pandoc input archive");
...
assert.match(linuxEngineStagingJob, /npm run prepare:linux-engine-sources/, "Linux engine staging must validate and stage source trees");
