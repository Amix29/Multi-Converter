...
assert.match(paddleIntelBuild, /refs\/\$\{kind\}\/\$\{localName\}/);
assert.match(paddleIntelBuild, /refs\/\$\{kind\}\/\$\{localName\}\^\{commit\}/);
assert.match(paddleIntelBuild, /branch", "-f", localName, entry\.commit/);
